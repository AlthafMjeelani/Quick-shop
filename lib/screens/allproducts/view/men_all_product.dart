...
class AllShirtsProduct extends StatelessWidget {
  const AllShirtsProduct({
    super.key,
    required this.list,
  ...
  Widget build(BuildContext context) {
    ...
    final productController =
        Provider.of<ScreenAllProductProvider>(context, listen: false);
              ...
              children: [
                GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    homeController.calculateOfferPrice(index);
                    productController.filterOfAllproducts(index, controller);
                    final product = list[index];
                    return GestureDetector(
                      onTap: () {
                        singleProductController
                            .getSingleProductDetails(product.id);
                        homeController.calculateOfferPrice(index);
                      },
                      child: Container(
